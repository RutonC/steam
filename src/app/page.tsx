  ...
  <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 shadow-sm w-full sm:w-2/3'>
    ...
    <div className='bg-slate-100/30 backdrop-blur-sm col-span-2 py-8 px-4 sm:py-16 sm:px-12 md:px-36'>
      <div className='sm:mt-12'>
        ...
        <h2 className='text-xl font-bold'>Local: <span className='text-md font-normal'>Centro Cultural de Camões, Chaimite Cidade da Beira</span></h2>
        <h2 className='text-xl font-bold'>Data:<span className='text-md font-normal'> 10 de Setembro de 2024 | Das 14h30min às 16h30min</span></h2>
        </div>
